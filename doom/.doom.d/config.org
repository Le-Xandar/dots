  ...
  (setq org-capture-templates
        '(
          ...
          ("ii" "Information" entry
           ...
           "* %?\n%i\n")
          ("iI" "Idea" entry
           (file+headline org-roam-intersting-file  "Idea")
           "* %?\n%i\n")
          ...
          ("r" "Rice")
          ("re" "Emacs" entry
           (file+headline +org-capture-todo-file  "Emacs :linux:emacs:rice:")
           "* TODO %?\n%i\n")
          ("rw" "Window Manager" entry
           (file+headline +org-capture-todo-file  "Window Manager :wm:linux:rice:")
           "* TODO %?\n%i\n")

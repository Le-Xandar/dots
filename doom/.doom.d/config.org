...
(setq org-college-file-path (concat org-directory "college.org"))
;; roam
...
(setq org-capture-templates
      '(("r" "To Read" entry
         (file+headline +org-capture-todo-file "To Read")
         "* TODO %?\n%i\n")
        ("c" "College")
        ("ch" "Homework" entry
         (file+headline org-college-file-path "Homework")
         "* TODO %?\n%i\n:PROPERTIES:\n:Created: %U\n:END:")
        ("ct" "Exam/Test" entry
         (file+headline org-college-file-path "Quiz")
         "* TODO %?\n%i\n:PROPERTIES:\n:Created: %U\n:END:")
        ("ce" "Event" entry
         (file+headline org-college-file-path "Event")
         "* TODO %?\n%i\n:PROPERTIES:\n:Created: %U\n:END:")
        ))
#+end_src
** Modes
